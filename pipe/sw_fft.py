# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/ripple-sw_fft.ipynb (unless otherwise specified).
...
def replace_margin_side(data, freq, is_rfi, mw_use, margin_width=20, ext_freq=1.3, side='both'):
    ...
    for ti in range(N):
        if ti not in is_rfi_num:
            ...
            newspec = replace_spec(ti, spec_, freq_, low_use, rfi_width_lim=0, 
                                ext_sec=1, ext=ext, RMS=RMS, MAX=MAX)
            newspec[-1] = 0
            data_[ti] = newspec
