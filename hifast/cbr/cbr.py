...
__all__ = ['robust_smooth', 'smooth_by_baseline', 'gen_args', 'parse_obs_log', 'Calibrator', 'MBC', 'OnOff', 'Mapping',
           'main']
...
def gen_args(argv=None):
    ...
    group.add_argument('--ref_drange', nargs=2, type=float, default=[690., 3600.],
