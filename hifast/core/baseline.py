# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/core/baseline.ipynb (unless otherwise specified).

__all__ = ['get_baseline', 'get_baseline_mp', 'BL_PLS', 'BL_arPLS', 'BL_base', 'BL_Chebyshev', 'BL_poly', 'BL_sin_poly',
           'BL_sin_poly_2', 'BL_asPLS', 'BL_masPLS', 'get_exclude_fun', 'sub_baseline']
...
class BL_PLS(object):
    ...
    def __init__(self, lam=10**12, offset=2, deg=3, ratio=0.01, niter=100, rew_type='asym', rew=True):
        """
        lam:
        offset:
        deg:
        ...
        self.ratio = ratio
        self.niter = niter
        BL_PLS._reweight = _rew_fun_dict[rew_type]
        if not rew:
            self.niter = 1
    ...
    def fit(self, *, x=None, y=None, exclude=None, exclude_type='end', wei=None):
        ...
        x: placeholder
        y: array;
        exclude: bool array; masked points that will never be used in fitting baseline
