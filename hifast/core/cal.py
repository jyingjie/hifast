# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/core/cal.ipynb (unless otherwise specified).

__all__ = ['FastRawData', 'adjust_frange', 'FastRawSpec', 'CalOnOff', 'plot_sep', 'mean_a', 'CalOnOffA']
