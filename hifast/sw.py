...
class IO(BaseIO):
    ...
    def _import_m(self,):
        ...
        from hifast.core.baseline import sub_baseline, get_exclude_fun
    ...
    def med_fit_sw(self, s1p, is_on=None,):
        from hifast.ripple.sw_fft import mean_fit_ripple, med_fit_ripple
        args = self.args
...
def interact(args):
    check_backend()
    import h5py
    from hifast.interaction import sw_i as interact
