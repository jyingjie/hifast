...
__all__ = ['replace_spec', 'save_rep', 'repalce_near', 'replace_margin_side', 'get_margin_num', 'replace_rfi_lower',
           'replace_rfi', 'find_loc', 'SW_FFT', 'get_sw_conf', 'fit_sw_fft', 'mean_fit_ripple', 'med_fit_ripple']
